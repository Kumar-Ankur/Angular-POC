    ...
    $scope.UserHobbyList = function() {
     ...
     $scope.getChat = function() {
        ...
        homeService.getChat(loggedEmail, function(result) {
           // $scope.chatPath='http://10.10.20.209:8080/chat/'+result.data[0].chat;
            window.open('http://10.10.22.125:9900/chat/'+result.data[0].chat, 'newwindow', 'width=300, height=250');
          //  $location.path('/chat');
         console.log("success");   
        }, function() {});
    };
